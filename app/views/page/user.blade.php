...
<div class="row">
  <div class="col-xs-12">
    ...
    <form action="{{ URL::route('user') }}" class="form-horizontal" method="post" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Nombre" value="{{ $user->firstname }}">
        </div>
      </div>
      <div class="form-group">
        <label for="lastname" class="col-sm-2 control-label">Apellido</label>
        <div class="col-sm-8">
          <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Apellido" value="{{ $user->lastname }}">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="dpi" id="dpi" placeholder="DPI" value="{{ $user->dpi }}">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div id="datetimepicker" class="input-append date col-sm-8">
           <input type="text" class="form-control" name="birthday" id="birthday" placeholder="Fecha de Nacimiento" value="{{ $user->birthday }}"></input>
           <span class="add-on">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="license" id="license" placeholder="Licencia" value="{{ $user->license }}">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="vehicle" id="vehicle" placeholder="Vehiculo" value="{{ $user->vehicle }}">
        </div>
      </div>
...
<div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="tons" id="tons" placeholder="Tons" value="{{ $user->tons }}">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="comments" id="comments" placeholder="Comentario" value="{{ $user->comments }}">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="workplace" id="workplace" placeholder="Lugar de trabajo" value="{{ $user->workplace }}">
        </div>
      </div>
