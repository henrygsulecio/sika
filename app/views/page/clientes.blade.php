  ...
  <div class="col-xs-12">
    ...
    <form action="{{ URL::route('cliente') }}" class="form-horizontal" method="post" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="direccion" id="direccion" placeholder="direccion" value="{{ $user->direccion }}">
        </div>
      </div>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="ncuenta" id="ncuenta" placeholder="ncuenta" value="{{ $user->ncuenta }}">
        </div>
      </div>
